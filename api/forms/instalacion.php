...
$form_instalacion = new Formulario(
	array(
		'destinatarios' => array(
			Config::obtener('empresa')->email,
			'anthoni97@gmail.com'
		),
		'asunto' 	=> 'Instalacion  - '.Config::obtener('empresa')->nombre,
		'remitente' => array(
...
$form_instalacion->agregarCampos(
	array(
...
if( isset($_POST['enviar_instalacion']) ){
	$form_instalacion->enviar();
}
