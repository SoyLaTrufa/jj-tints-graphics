...
(function() {
	...
	Promise.all([
		...
		var EthnocentricRegular = new FontFaceObserver('EthnocentricRegular', {
			weight: 400
		});

		var BebasRegular = new FontFaceObserver('BebasRegular', {
			weight: 400
		});
		var OpenSansLight = new FontFaceObserver('OpenSansLight', {
			weight: 300
		});
